...
public class Stock  {
	...
	public void editProducts (long id, String name, Double price, Integer quantity, String category) {
		removeProduct(id);
		//criar uma condi��o de sair quando quiser ap�s clicar na op��o para editar (nas demais tamb�m)
	...
	public void addProductfromMostruario() {
		...
		for (ProductMostruario productMostruario : productsMostruario) {
			...
			if (indexNumber == -1) { //se � existe na lista de produtos 1 elemento c/ este c�digo de barra, add na lista
